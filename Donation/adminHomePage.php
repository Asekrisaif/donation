    ...
    <div class="nevbar" id="nevbar" >
        ...
        <div class="menu" id="menu">
            <ul>
                ...
                <li id="login" class="login dropdown"><span><i class="bi bi-person-fill"></i>&nbsp;Admin&nbsp;&nbsp;&nbsp;&nbsp;</span> 
                    <ul>
                        
                        <li><a id="donate" href="modif.php" target="blank">Delete user</a></li>
                        <li><a id="donate" href="tableaux.php" target="blank">liste user</a></li>
