...
$sql = "SELECT  FROM ";
    ...
    while ($row = $result->fetch_assoc()) {
        if (isset($row["nb_donation"])) {
            $Nbinc_Avril_lun = $row["nb_donation"];
...
if (!$result) {
  ...
  ?>
    <script>
        ...
        xaxis: {
           categories: ['<?php echo $jmoins7_2 ?>','<?php echo $jmoins6_2 ?>','<?php echo $jmoins5_2 ?>', '<?php echo $jmoins4_2 ?>', '<?php echo $jmoins3_2 ?>', '<?php echo $jmoins2_2 ?>', '<?php echo $jmoins1_2 ?>'],
 title: {
